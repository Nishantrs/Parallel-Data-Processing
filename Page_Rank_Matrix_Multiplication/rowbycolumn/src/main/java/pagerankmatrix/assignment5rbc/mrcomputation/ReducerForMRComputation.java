...
public class ReducerForMRComputation extends Reducer<LongWritable, DoubleWritable, Text, NullWritable> {
	...
	public void reduce(LongWritable key, Iterable<DoubleWritable> values, Context context) throws IOException, InterruptedException {
		...
		pageRankScore = RANDOM_JUMP_PROBABILITY/noOfNodes + (1 - RANDOM_JUMP_PROBABILITY)*(danglingFactor + accumulatedContribution);
