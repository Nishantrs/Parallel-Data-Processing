...
public class MapperForReading extends Mapper<Object, Text, Text, NullWritable>{
	...
	public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
		...
		// Creating a set of unique data nodes assuming input file has unique nodes to count
		// initial list of nodes.
		uniqueNodes.add(pageName);
		...
		context.write(new Text(outputFormat.toString()),nw.get());
	...
	//  Storing the value of total number of unique nodes in global counter
	public void cleanup(Context context) throws IOException, InterruptedException {

		context.getCounter(PAGE_RANK_COUNTER.NO_OF_NODES).setValue(uniqueNodes.size());
